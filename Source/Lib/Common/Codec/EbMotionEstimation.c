...
#if NSQ_TABLES_NREF
#if m0_nsq_table
    is_nsq_table_used = ((picture_control_set_ptr->enc_mode <= ENC_M1 && picture_control_set_ptr->is_used_as_reference_flag) || (picture_control_set_ptr->enc_mode <= ENC_M1 && picture_control_set_ptr->sc_content_detected))
#else
